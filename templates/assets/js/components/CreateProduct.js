...
const CreateProduct = (props) => {
    ...
    const saveProduct = async (event) => {
        ...
        try {
            ...
            // Make a POST request to the Django backend to save the product
                        ...
                        <div className="card shadow mb-4">
                            <div className="card-body">
                                <div className="form-group">
                                    ...
                                    <input type="text" placeholder="Product Name" className="form-control" name="title"/>
                                </div>
                                <div className="form-group">
                                    <label htmlFor="">Product SKU</label>
                                    <input type="text" placeholder="Product Name" className="form-control" name="sku"/>
                                </div>
                                <div className="form-group">
                                    <label htmlFor="">Description</label>
                                    <textarea id="" cols="30" rows="4" className="form-control" name='description'></textarea>
                                </div>
                            </div>
                        </div>
